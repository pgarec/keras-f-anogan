...
if __name__ == '__main__':
    ...
    axes.append(fig.add_subplot(rows, cols, 0*cols + 1))
    plt.imshow(real0.squeeze())
    axes.append(fig.add_subplot(rows, cols, 0 * cols + 2))
    plt.imshow(real_regen0.squeeze())
    axes.append(fig.add_subplot(rows, cols, 0 * cols + 3))
    plt.imshow(real0.squeeze()-real_regen0.squeeze())

    axes.append(fig.add_subplot(rows, cols, 1 * cols + 1))
    plt.imshow(fake1.squeeze())
    axes.append(fig.add_subplot(rows, cols, 1 * cols + 2))
    plt.imshow(fake_regen1.squeeze())
    axes.append(fig.add_subplot(rows, cols, 1 * cols + 3))
    plt.imshow(fake1.squeeze() - fake_regen1.squeeze())

    axes.append(fig.add_subplot(rows, cols, 2 * cols + 1))
    plt.imshow(fake2.squeeze())
    axes.append(fig.add_subplot(rows, cols, 2 * cols + 2))
    plt.imshow(fake_regen2.squeeze())
    axes.append(fig.add_subplot(rows, cols, 2 * cols + 3))
    plt.imshow(fake2.squeeze() - fake_regen2.squeeze())

    axes.append(fig.add_subplot(rows, cols, 3 * cols + 1))
    plt.imshow(fake3.squeeze())
    axes.append(fig.add_subplot(rows, cols, 3 * cols + 2))
    plt.imshow(fake_regen3.squeeze())
    axes.append(fig.add_subplot(rows, cols, 3 * cols + 3))
    plt.imshow(fake3.squeeze() - fake_regen3.squeeze())

    axes.append(fig.add_subplot(rows, cols, 4 * cols + 1))
    plt.imshow(fake4.squeeze())
    axes.append(fig.add_subplot(rows, cols, 4 * cols + 2))
    plt.imshow(fake_regen4.squeeze())
    axes.append(fig.add_subplot(rows, cols, 4 * cols + 3))
    plt.imshow(fake4.squeeze() - fake_regen4.squeeze())

    axes.append(fig.add_subplot(rows, cols, 5 * cols + 1))
    plt.imshow(fake5.squeeze())
    axes.append(fig.add_subplot(rows, cols, 5 * cols + 2))
    plt.imshow(fake_regen5.squeeze())
    axes.append(fig.add_subplot(rows, cols, 5 * cols + 3))
    plt.imshow(fake5.squeeze() - fake_regen5.squeeze())

    axes.append(fig.add_subplot(rows, cols, 6 * cols + 1))
    plt.imshow(fake6.squeeze())
    axes.append(fig.add_subplot(rows, cols, 6 * cols + 2))
    plt.imshow(fake_regen6.squeeze())
    axes.append(fig.add_subplot(rows, cols, 6 * cols + 3))
    plt.imshow(fake6.squeeze() - fake_regen6.squeeze())

    axes.append(fig.add_subplot(rows, cols, 7 * cols + 1))
    plt.imshow(fake7.squeeze())
    axes.append(fig.add_subplot(rows, cols, 7 * cols + 2))
    plt.imshow(fake_regen7.squeeze())
    axes.append(fig.add_subplot(rows, cols, 7 * cols + 3))
    plt.imshow(fake7.squeeze() - fake_regen7.squeeze())

    axes.append(fig.add_subplot(rows, cols, 8 * cols + 1))
    plt.imshow(fake8.squeeze())
    axes.append(fig.add_subplot(rows, cols, 8 * cols + 2))
    plt.imshow(fake_regen8.squeeze())
    axes.append(fig.add_subplot(rows, cols, 8 * cols + 3))
    plt.imshow(fake8.squeeze() - fake_regen8.squeeze())
